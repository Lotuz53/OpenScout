...
class Settings(BaseSettings):
    ...
    # .env-template; existing ones switch by setting this and running docsgpt.scripts.reembed.
    ...
    #             DeepSeek-OCR endpoint (docsgpt/parser/file/ocr_parser.py).
    ...
    # Trust-check anydoc's PDF output (docsgpt/parser/file/pdf_trust.py):
    ...
    # markdown into GFM tables (docsgpt/parser/file/tableize.py). Off by
